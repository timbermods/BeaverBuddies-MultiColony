...
| **Joining** | Host only, and only while players can still join (the game waits at its start and nothing has changed it): *open: unpausing, or any change, closes it*. The line disappears once the game has started. A game started from a new game's waiting room never shows it: joining closed at **Start Game**. |
...
A new game's waiting room (1.4.0-beta18) closes to newcomers at **Start Game**; everyone in the
room comes into the game.
