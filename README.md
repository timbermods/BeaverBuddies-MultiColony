...
> - **Not played yet:** starting a game from the waiting room; Folktails and Iron Teeth together; looking after an
...
- **Hand over a colony after its player is away (days)**: 0 (never) by default. A player stepping
...
- **Mixed factions for new games (beta)**, off (not played yet): on, with separate colonies and every
  ...
  game's two factions: with a mod that adds a faction, new games stay one faction.
...
*Not played yet.* With **Mixed factions for new games** on, every colony plays its own faction:
