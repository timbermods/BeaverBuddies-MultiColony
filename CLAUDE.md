...
- The hero name plate is the exception (Kyler, 2026-09-24): no keyline, set in a mitred timber frame
  (`docs/assets/name-frame-{day,night}.svg`, a border-image nine-slice), the name in Barlow Black with hand-cut edges
  (`#hewn` filter) and a split log-end o. DESIGN.md's Name plate entry has the details.
- Fonts: Barlow Semi Condensed 600/700, and 900 for the name plate only
  (`docs/assets/fonts/barlow-semi-condensed-latin-{600,700,900}.woff2`, licence `OFL-Barlow.txt`); body is system-ui,
